...
<body>
		...
		<div class="line1">
			<div class="fir">
				<button type="button" class="button_img" name="bul" id="pizza"
					onclick="click_bul()">
					<img src="http://localhost:8080/kiosk/images/egovframework/example/bul.png" alt="이미지 버튼" width="200" height="200">
				</button>
				<h3>불고기 피자</h3>
			...
			<div class="fir">
				<button type="button" class="button_img" name="pepe" id="pizza"
					onclick="click_pepe()">
					<img src="http://localhost:8080/kiosk/images/egovframework/example/pepe.png" alt="이미지 버튼" width="200" height="200">
				</button>
				<h3>페페로니 피자</h3>
				<h5>R:13000원 L:20000원</h5>
			</div>
			...
			<div class="fir">
				<button type="button" class="button_img" name="chese" id="pizza"
					onclick="click_chese()">
					<img src="http://localhost:8080/kiosk/images/egovframework/example/chese.png" alt="이미지 버튼" width="200" height="200">
				</button>
				<h3>치즈 피자</h3>
		...
		<div class="line2">
			<div class="fir">
				<button type="button" class="button_img" name="spa" id="pasta"
					onclick="click_spa()">
					<img src="http://localhost:8080/kiosk/images/egovframework/example/spa.png" alt="이미지 버튼" width="200" height="200">
				</button>
				<h3>토마토 파스타</h3>
				<h5>8000원</h5>
			</div>
			...
			<div class="fir">
				<button type="button" class="button_img" name="sea"
					onclick="click_sea()">
					<img src="http://localhost:8080/kiosk/images/egovframework/example/sea.png" alt="이미지 버튼" width="200" height="200">
				</button>
				<h3>해물 파스타</h3>
				<h5>8000원</h5>
			</div>
			...
			<div class="fir">
				<button type="button" class="button_img" name="hot"
					onclick="click_hot()">
					<img src="http://localhost:8080/kiosk/images/egovframework/example/hot.png" alt="이미지 버튼" width="200" height="200">
				</button>
				<h3>홍합 파스타</h3>
				<h5>8000원</h5>
			</div>
		...
		<div class="line3">
			<div class="fir">
				<button type="button" class="button_img" name="cola"
					onclick="click_cola()">
					<img src="http://localhost:8080/kiosk/images/egovframework/example/cola.png"
			...
			<div class="fir">
				<button type="button" class="button_img" name="sprite"
					...
					<img src="http://localhost:8080/kiosk/images/egovframework/example/sprite.jpg" alt="이미지 버튼" width="150" height="150">
				</button>
				<h3>스프라이트</h3>
				<h5>2000원</h5>
			</div>
	...
	<div class="right_width">
		...
		<div class="pasta_order" id="pasta_order">
			<input type='button' onclick='pasta("minus")' value='-' /> 
			<input type="text" name="pasta" id="text" readonly />
			<input type='button' onclick='pasta("plus")' value='+' />

			<div id='pasta_count'>-</div>
			<br>
		</div>
		<div class="drink_order" id="drink_order">
			<input type='button' onclick='drink("minus")' value='-' /> 
			<input type="text" name="drink" id="text" readonly /> 
			<input type='button' onclick='drink("plus")' value='+' />
		...
		<div>
			<p>
				<textarea cols="50" rows="10" class="area"></textarea>
			</p>
		</div>
		<div>
		...
		<div>
			<form action="OrderServlet" method="post">
				<input type="hidden" name="menu_name" id="hiddenMenuName" /> 
				<input type="hidden" name="menu_size" id="hiddenMenuSize" /> 
				<input type="hidden" name="quantity" id="hiddenQuantity" /> 
				<input type="hidden" name="total_price" id="hiddenTotalPrice" />
				<button class="reset" onClick="resetTotal()">초기화</button>
				<button class="order_button" onclick="submitOrder()">주문하기</button>
			</form>
		</div>
		<div class=order></div>
	</div>
...
<script>
	...
	function pizza(action) {
		...
		document.getElementById('pizza_count').innerHTML = order[pizzaKey] + '판';
	...
	function pasta(action) {
		...
		document.getElementById('pasta_count').innerHTML = order[pastaName] + '인분';
		document.querySelector('input[name="total"]').value = total;
		updateOrderList();
	}
	...
	function drink(action) {
		...
		document.getElementById('drink_count').innerHTML = order[drinkName] + '개';
		document.querySelector('input[name="total"]').value = total;
		updateOrderList();
	}
